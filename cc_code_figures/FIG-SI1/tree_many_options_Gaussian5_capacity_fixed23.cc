...
int main(void)
{
	...
	value_actions = fopen("value_actions_gauss_capacity_fixed23.m", "w");
	value_actions_th = fopen("value_actions_gauss_capacity_fixed_th23.m", "w");
