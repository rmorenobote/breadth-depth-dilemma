...
int main(void)
{
	...
	value_actions = fopen("value_actions_gauss_capacity_fixed22.m", "w");
	value_actions_th = fopen("value_actions_gauss_capacity_fixed_th22.m", "w");
