...
int main(void)
{
	...
	//use squares to compare
	const int     N_vec[7] = { 14, 15, 16, 17, 18, 19, 20 };
	const int     num_N = 7;
	...
	value_actions = fopen("value_actions_gradient7_dyn_alloc5_other_approxs24.m", "w");
	value_actions_breadth = fopen("value_actions_gradient7_dyn_alloc5_other_approxs_breadth24.m", "w");
	value_actions_depth = fopen("value_actions_gradient7_dyn_alloc5_other_approxs_depth24.m", "w");
	value_actions_random = fopen("value_actions_gradient7_dyn_alloc5_other_approxs_random24.m", "w");
	value_actions_triangular = fopen("value_actions_gradient7_dyn_alloc5_other_approxs_triangular24.m", "w");
	value_actions_sq_root = fopen("value_actions_gradient7_dyn_alloc5_other_approxs_sq_root24.m", "w");
	distributions = fopen("distributions7_dyn_alloc5_other_approxs24.m", "w");
