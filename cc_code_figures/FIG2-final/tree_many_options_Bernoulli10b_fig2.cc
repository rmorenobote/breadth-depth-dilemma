...
int main(void)
{
	...
	const double  alpha = 3; //if different from one, not flat prior
	...
	value_actions = fopen("value_actions2b.m", "w");
	value_actions_per = fopen("value_actions_per2b.m", "w");
	value_actions_th = fopen("value_actions_th2b.m", "w");
